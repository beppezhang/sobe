...
function gobuy() {
	...
	var url = "/goBuy.htm?cartID=" + itemID + "&number=" + itemCount + "&type="
...
jQuery(document)
		.ready(
				function() {
					...
					jQuery(function() {
						/*
						 * jQuery(".sel span a").click(function(e){
						 * e.preventDefault();
						 * jQuery(this).closest("span").toggleClass('cur').siblings().removeClass(); })
						 */

...
public interface HistroyDAO {
    ...
    public Integer insert(HistroyDTO record);

    public Integer insertSelective(HistroyDTO record);

    HistroyDTO selectByPrimaryKey(Long id);

    public Integer updateByPrimaryKeySelective(HistroyDTO record);

    public Integer updateByPrimaryKey(HistroyDTO record);
     ...
     * @Description
     */
    public HistroyVO findHistroyByCustomer(HistroyDTO histroyDTO);
     ...
     * @Description
     */
    public void updateHistroyByID(Long id);
}

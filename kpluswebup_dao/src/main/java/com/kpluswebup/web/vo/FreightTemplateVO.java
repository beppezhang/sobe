...
public class FreightTemplateVO {
    ...
    private List<FreightTemplatePriceVO> priceList=new ArrayList<FreightTemplatePriceVO>();
	...
	public List<FreightTemplatePriceVO> getPriceList() {
		return priceList;
	}

	public void setPriceList(List<FreightTemplatePriceVO> priceList) {
